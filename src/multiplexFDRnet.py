...
def multiplexFDRnetMain(mx,seed,fdr_bound,size=400,time_limit=100,relative_gap=0.01):
...
def run(args):
    ...
    result = multiplexFDRnetMain(mx,seed=args.seed,fdr_bound=args.bound,size=args.size,time_limit=args.time_limit,relative_gap=args.relative_gap)
